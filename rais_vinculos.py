...
ftp.cwd('/pdet/microdados/RAIS/2017')
...
caminho_pasta = 'C:/Python/RAIS/Vinculos/2017_'
...
try:
    os.remove(caminho_pasta + 'PR2017.7z')
except:
...
getFile(ftp, 'PR2017.7z')

# 8. Descompactar e converter para csv

try:
    patoolib.extract_archive(caminho_pasta + "PR2017.7z", outdir=caminho_pasta_txt, program="C/Program Files/7-Zip/7z.exe")
